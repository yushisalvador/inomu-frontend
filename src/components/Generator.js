  ...
  return (
    <div>
      <button
        ...
        className="mt-2 mb-2 border-solid border-2 border-primary p-2 rounded-full bg-navClick scale-100 hover:scale-105 hover:bg-white hover:text-navClick font-semibold"
      >
        Generate cocktail
      </button>
